...
| Geometric stiffness **K_σ** | `GeometricStiffnessOperator.assemble_K_sigma(N_gp, M_y_gp, M_z_gp, weights, dN_dx, jacobian)`, [utilities/geometric_stiffness.py](utilities/geometric_stiffness.py) |
