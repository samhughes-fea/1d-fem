# pre_processing\element_library\timoshenko\timoshenko_3D.py
...
from pre_processing.element_library.timoshenko.utilities.interpolate_loads import LoadInterpolationOperator
...
class TimoshenkoBeamElement3D(Element1DBase):
    """
