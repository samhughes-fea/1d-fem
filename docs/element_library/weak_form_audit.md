...
| `nonlinear_timoshenko_3D` | — | Gauss | same | Gauss ref. | Gauss | Gauss | **Gauss** | Same operator as EB for `K_σ` on these DOFs |
| `gebt_shear_3D` | — | Gauss | same | Gauss ref. | Gauss | Gauss | **Gauss** | Uses Timoshenko `GeometricStiffnessOperator` |
