# Roark formulae – validation visualisers
...
| `verification/` | Outputs from `roark_verification.py`: `roark_verification_point_loads.png`, `roark_verification_distributed_loads.png`, `roark_verification_data.csv`. |
...
```text
python post_processing/validation_visualisers/roarks_formulas/roark_verification.py
```
...
```text
python post_processing/validation_visualisers/roarks_formulas/roarks_formulas_visualiser.py
```
