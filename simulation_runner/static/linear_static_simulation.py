# simulation_runner/static/linear_static_simulation.py
"""
Linear static finite element analysis: one-shot solve K_global U_global = F_global.

Assembles from pre_processing elements, applies BCs and condensation, solves, then computes
primary (reactions, residual), secondary (strain, stress, energy), and tertiary (section forces,
principal stress, integrated elemental) results; can save to job results directory.
"""
