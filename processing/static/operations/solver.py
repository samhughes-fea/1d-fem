# processing/static/operations/solver.py

"""
processing.static.operations.solver
---------------------------------------
...
class SolveCondensedSystem:
    ...
    * iterative solvers registered in ``processing.solver_registry``
    ...
    * extensive diagnostics + CSV exports
    ...
    def __init__(
        ...
        *,
        ...
        from processing.solver_registry import LinearSolverRegistry
